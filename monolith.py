...
apiKey = ssmClient.get_parameter(Name='/interstella/apiKey-{}'.format(EnvironmentName))['Parameter']['Value']
endpoint = ssmClient.get_parameter(Name='/interstella/apiEndpoint-{}'.format(EnvironmentName))['Parameter']['Value']
orderTopic = ssmClient.get_parameter(Name='/interstella/orderTopic-{}'.format(EnvironmentName))['Parameter']['Value']
